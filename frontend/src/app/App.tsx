...
export default function App() {
  ...
  if (isLoading) {
    // 흰 배경 + 금색 P 로고만 (네이티브 스플래시와 동일 톤). 스피너/텍스트 제거.
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: "#FFFFFF" }}>
        <svg width="104" height="104" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" aria-label="Palette" className="animate-pulse">
          <defs>
