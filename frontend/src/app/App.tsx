...
export default function App() {
  ...
  if (isLoading) {
    // 흰 배경 + 앱아이콘 배지(taupe 라운드 스퀘어 + 금색 P + 그림자)를 중앙에.
    // 네이티브 스플래시(Splash.imageset)와 동일한 톤·입체감으로 매칭.
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: "#FFFFFF" }}>
        <div
          ...
          style={{
            ...
            height: 120,
            borderRadius: 28,
            background: "linear-gradient(135deg, #A98C72 0%, #6E5645 100%)",
            boxShadow: "0 18px 50px rgba(90, 67, 48, 0.34)",
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
          }}
        >
          <svg width="78" height="78" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" aria-label="Palette">
            <defs>
              <linearGradient id="palette-splash-gold" x1="0" y1="0" x2="0" y2="1">
                <stop offset="0" stopColor="#E6C66A" />
                <stop offset="0.55" stopColor="#C2A14E" />
                <stop offset="1" stopColor="#9C7E38" />
              </linearGradient>
            </defs>
            <path
              transform="translate(58.76 399.54) scale(0.4038 -0.4038)"
              fill="url(#palette-splash-gold)"
