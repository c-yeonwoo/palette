...
const SECTIONS: Array<{ title: string; body: string }> = [
  ...
  {
    title: "제6조 (외부 송금 유도 금지 · 주선자 의무)",
    body:
      "• 주선자는 사용자에게 앱 외부 채널(계좌이체·간편송금·현금)을 통한 감사 표시(팁)를 유도해서는 안 됩니다.\n" +
      "• 모든 감사 표시는 앱 내 팁 기능을 통해서만 받아야 합니다 (주선자 90% 수령, 플랫폼 10% 수수료).\n" +
      "• 위반 적발 시 다음의 페널티가 즉시 적용됩니다:\n" +
      "  – 누적 잔액(`paidPoints` + `bonusPoints`) 전액 몰수\n" +
      "  – 출금 자격 영구 박탈\n" +
      "  – 등급 0 회귀 (모든 성사 기록 reset)\n" +
      "  – 계정 영구 정지 (동일 명의/디바이스 재가입 차단)\n" +
      "• 사용자에 대한 환불·보상 의무는 없습니다.\n" +
      "• 위반 사실은 앱 내 “신고하기” → “외부 송금 유도” 카테고리로 신고할 수 있으며, 확정 시 신고 사용자에게 50 물감이 보상으로 지급됩니다.",
  },
  {
    title: "제7조 (계정 탈퇴)",
    body:
