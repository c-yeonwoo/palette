    ...
    <div className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center gap-8 px-6 max-w-md w-full">
        ...
        <div className="text-center flex flex-col items-center gap-6">
          ...
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-[#C9A86A]/40 bg-[#C9A86A]/10 backdrop-blur-sm">
            <span className="w-1.5 h-1.5 rounded-full bg-[#C9A86A]" />
            <span className="text-[#C9A86A] text-[0.7rem] font-semibold uppercase tracking-[0.24em]">
              Closed Beta
            </span>
          </div>
        </div>
        ...
        <div className="w-full mt-2 space-y-4">
          ...
          <div className="space-y-2.5">
            ...
            <input
              ...
              spellCheck={false}
              className="w-full h-14 px-4 rounded-2xl bg-white/10 border border-white/20 text-white text-base placeholder-white/30 tracking-[0.2em] text-center font-mono backdrop-blur-md focus:outline-none focus:border-[#C9A86A]/60 focus:bg-white/15 transition-colors"
            />
          </div>
        ...
        <p className="text-white/60 text-xs text-center mt-2 leading-relaxed">
          베타 코드가 없으신가요?<br />
          인스타그램 <span className="text-[#C9A86A] font-medium">@palette.kr</span> 에서 신청해주세요
        </p>
      </div>
    </div>
  );
