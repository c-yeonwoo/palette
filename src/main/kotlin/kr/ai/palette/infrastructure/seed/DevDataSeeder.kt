...
class DevDataSeeder(
    ...
    private fun seedTestAccount(now: Instant): UserEntity {
        ...
        profileRepo.save(buildProfile(
            ...
            height = 178, bodyType = BodyTypeEntity.AVERAGE.name,
            mbti = MBTIEntity.ENFP, career = CareerCategoryEntity.IT_DEVELOPMENT,
            sido = "서울", sigungu = "강남구",
            smoking = FrequencyEntity.NEVER.name, drinking = FrequencyEntity.SOMETIMES.name,
            religion = ReligionEntity.NONE.name,
    ...
    private fun seedRegularUsers(now: Instant): List<UserEntity> {
        val users = listOf(
            ...
            SeedUser("지수", "이지수", "01011110001", LocalDate.of(1998, 4, 10), GenderEntity.FEMALE,
                178, BodyTypeEntity.SLIM.name, MBTIEntity.ISTJ, CareerCategoryEntity.FINANCE,
                "서울", "강남구", FrequencyEntity.NEVER.name, FrequencyEntity.SOMETIMES.name, ReligionEntity.NONE.name,
                "독서,요가,카페,여행", "blue", 75,
            ...
            SeedUser("하은", "박하은", "01011110002", LocalDate.of(1997, 7, 22), GenderEntity.FEMALE,
                160, BodyTypeEntity.SLIM.name, MBTIEntity.INFJ, CareerCategoryEntity.MEDIA,
                "서울", "마포구", FrequencyEntity.NEVER.name, FrequencyEntity.SOMETIMES.name, ReligionEntity.CHRISTIANITY.name,
                "그림,음악,독서,영화", "pink", 65,
            ...
            SeedUser("수현", "최수현", "01011110003", LocalDate.of(1995, 11, 5), GenderEntity.FEMALE,
                168, BodyTypeEntity.ATHLETIC.name, MBTIEntity.ENTJ, CareerCategoryEntity.PROFESSIONAL,
                "서울", "송파구", FrequencyEntity.NEVER.name, FrequencyEntity.OFTEN.name, ReligionEntity.NONE.name,
            ...
            SeedUser("예진", "강예진", "01011110004", LocalDate.of(1999, 2, 28), GenderEntity.FEMALE,
                163, BodyTypeEntity.SLIM.name, MBTIEntity.ESFP, CareerCategoryEntity.EDUCATION,
                "경기", "성남시", FrequencyEntity.NEVER.name, FrequencyEntity.SOMETIMES.name, ReligionEntity.NONE.name,
            ...
            SeedUser("서연", "윤서연", "01011110005", LocalDate.of(1996, 9, 14), GenderEntity.FEMALE,
                165, BodyTypeEntity.AVERAGE.name, MBTIEntity.INFP, CareerCategoryEntity.IT_DEVELOPMENT,
                "서울", "성동구", FrequencyEntity.NEVER.name, FrequencyEntity.SOMETIMES.name, ReligionEntity.NONE.name,
            ...
            SeedUser("민지", "정민지", "01011110006", LocalDate.of(1997, 5, 30), GenderEntity.FEMALE,
                162, BodyTypeEntity.SLIM.name, MBTIEntity.ENFJ, CareerCategoryEntity.MEDICAL,
                "서울", "관악구", FrequencyEntity.NEVER.name, FrequencyEntity.NEVER.name, ReligionEntity.NONE.name,
            ...
            SeedUser("준혁", "김준혁", "01011110007", LocalDate.of(1994, 8, 17), GenderEntity.MALE,
                180, BodyTypeEntity.ATHLETIC.name, MBTIEntity.ENTP, CareerCategoryEntity.IT_DEVELOPMENT,
                "서울", "강남구", FrequencyEntity.NEVER.name, FrequencyEntity.SOMETIMES.name, ReligionEntity.NONE.name,
            ...
            SeedUser("태양", "박태양", "01011110008", LocalDate.of(1993, 12, 3), GenderEntity.MALE,
                175, BodyTypeEntity.MUSCULAR.name, MBTIEntity.ESTJ, CareerCategoryEntity.FINANCE,
                "서울", "여의도", FrequencyEntity.NEVER.name, FrequencyEntity.SOMETIMES.name, ReligionEntity.NONE.name,
            ...
            SeedUser("민수", "이민수", "01011110009", LocalDate.of(1995, 6, 20), GenderEntity.MALE,
                172, BodyTypeEntity.AVERAGE.name, MBTIEntity.ISFJ, CareerCategoryEntity.EDUCATION,
                "경기", "수원시", FrequencyEntity.NEVER.name, FrequencyEntity.NEVER.name, ReligionEntity.CHRISTIANITY.name,
            ...
            SeedUser("재원", "조재원", "01011110010", LocalDate.of(1996, 1, 8), GenderEntity.MALE,
                177, BodyTypeEntity.SLIM.name, MBTIEntity.INTP, CareerCategoryEntity.IT_DEVELOPMENT,
                "서울", "마포구", FrequencyEntity.NEVER.name, FrequencyEntity.SOMETIMES.name, ReligionEntity.NONE.name,
            ...
            SeedUser("성호", "한성호", "01011110011", LocalDate.of(1992, 3, 25), GenderEntity.MALE,
                183, BodyTypeEntity.ATHLETIC.name, MBTIEntity.ESTP, CareerCategoryEntity.PROFESSIONAL,
                "서울", "강서구", FrequencyEntity.SOMETIMES.name, FrequencyEntity.SOMETIMES.name, ReligionEntity.NONE.name,
                "축구,헬스,여행,맛집", "red", 76,
            ...
            SeedUser("현우", "류현우", "01011110012", LocalDate.of(1997, 10, 11), GenderEntity.MALE,
                174, BodyTypeEntity.AVERAGE.name, MBTIEntity.ENFP, CareerCategoryEntity.MEDIA,
                "서울", "홍대", FrequencyEntity.NEVER.name, FrequencyEntity.SOMETIMES.name, ReligionEntity.NONE.name,
    ...
    private fun seedMatchmakerUsers(now: Instant): List<UserEntity> {
        ...
        return matchmakers.mapIndexed { idx, (name, birth, gender) ->
            ...
            profileRepo.save(buildProfile(
                ...
                bodyType = BodyTypeEntity.AVERAGE.name, mbti = MBTIEntity.ENFJ,
    ...
    private fun buildProfile(
        ...
        height: Int, bodyType: String, mbti: MBTIEntity,
        career: CareerCategoryEntity, sido: String, sigungu: String,
        smoking: String, drinking: String, religion: String,
    ...
    private data class SeedUser(
        ...
        val height: Int, val bodyType: String, val mbti: MBTIEntity,
        val career: CareerCategoryEntity, val sido: String, val sigungu: String,
        val smoking: String, val drinking: String,
        val religion: String, val interests: String,
