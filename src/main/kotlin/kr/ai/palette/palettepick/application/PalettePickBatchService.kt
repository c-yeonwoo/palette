...
class PalettePickBatchService(
    ...
    fun runNightly() {
        ...
        log.info("팔레트픽 배치 시작 — date={} 활성 사용자={} top-N={} max-calls={}",
            today, activeUsers.size, topN, maxCallsPerNight)
        ...
        log.info("팔레트픽 배치 완료 — viewers={} calls={} failures={}", viewers, calls, failures)
    }
